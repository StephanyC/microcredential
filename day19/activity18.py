...
# example 3: print between 12 and 30
print("-------- Example 3: nest if statement in while loop -------------")
y = 12
while y<30:
    if y%2 !=0: 
        print('y=',y)
...
print("-------- Example 4: The else statement in while loop -------------")
m = 10
while m >0:
    print("m = ", m)
    m-=1
...
while add<30:
    ...
    if add>30:
        break
    print('number1 =', number1 ,'number2 = ',number2, 'sum= ', add)


print('OUTSIDE! number1 =', number1, 'number2 = ', number2, ',sum= ', add)
